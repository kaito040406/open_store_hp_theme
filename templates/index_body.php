            ...
            <div id="rs-services" class="rs-services style16 bg29">
                <div class="container">
                    ...
                    <div class="row">
                            ...
                            <div class="services-wrap">
                                <a href="/service/consulting">
                                    ...
                                    <div class="services-txt">
                                        <h4 class="services-title">WEBコンサルティング</h4>
                        ...
                        <div class="col-lg-4 col-md-6 mb-25">
                            <div class="services-wrap">
                                <a href="/service/webservice">
                                    ...
                                    <div class="services-txt">
                                        <h4 class="services-title">WEBサービス制作/開発</h4>
                        ...
                        <div class="col-lg-4 col-md-6 mb-25">
                            <div class="services-wrap">
                                <a href="/service/ecservice">
                                    <div class="icon-part">
                                        <i class="fa fa-envelope-o"></i>
                                    </div>
                                    <div class="services-txt">
                                        <h4 class="services-title">ECサイト構築/運営</h4>
                        ...
                        <div class="col-lg-4 col-md-6 md-mb-25">
                            <div class="services-wrap">
                                <a href="/service/webmarketing">
                                    ...
                                    <div class="services-txt">
                                        <h4 class="services-title">WEBマーケティング/運用</h4>
                        ...
                        <div class="col-lg-4 col-md-6 sm-mb-25">
                            <div class="services-wrap">
                                <a href="/service/creative">
                                    ...
                                    <div class="services-txt">
                                        <h4 class="services-title">クリエイティブ制作</h4>
                        ...
                        <div class="col-lg-4 col-md-6">
                            <div class="services-wrap">
                                <a href="/service/system">
                                    ...
                                    <div class="services-txt">
                                        <h4 class="services-title">システム開発</h4>
