...
<html lang="zxx">
    <head>
        <!-- meta tag -->
        <meta charset="utf-8">
        <title>About – Reobiz – Consulting Business HTML Template</title>
                    ...
                    <div class="row y-middle mb-64 lg-mb-30 md-mb-0">
                        <div class="col-lg-6 md-mb-95">
                            <div class="image-part">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/about/inner/left-img.jpg" alt="">
                    ...
                    <div class="rs-carousel owl-carousel" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="false" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="1" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="3" data-lg-device="3" data-md-device-nav="false" data-md-device-dots="false">
                        <div class="team-item">
                            <div class="team-image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/1.jpg" alt="Team Image">
                            </div>
                        ...
                        <div class="team-item">
                            <div class="team-image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/2.jpg" alt="Team Image">
                            </div>
                            <div class="text-bottom">
                        ...
                        <div class="team-item">
                            <div class="team-image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/3.jpg" alt="Team Image">
                            </div>
                            <div class="text-bottom">
                        ...
                        <div class="team-item">
                            <div class="team-image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/4.jpg" alt="Team Image">
                            </div>
                            <div class="text-bottom">
                        ...
                        <div class="team-item">
                            <div class="team-image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/5.jpg" alt="Team Image">
                            </div>
                            <div class="text-bottom">
                        ...
                        <div class="team-item">
                            <div class="team-image">
                                <img src="<?php echo get_template_directory_uri(); ?>/assets/images/team/6.jpg" alt="Team Image">
                            </div>
                            <div class="text-bottom">
