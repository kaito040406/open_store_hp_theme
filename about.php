    ...
    <div class="container">
        <div class="kaisha_bun">
            ...
            <div class="kaisha_bun_me">
                <p>
                    今日、私たちは100年に一度のパンデミックによる激動の時代を生きています。<br>
                    新型コロナウイルスによる経済ダメージはリーマンショックを超えるとも言われています。<br><br>

                    このコロナ渦では、オフライン(対面)縮小・オンライン拡大といった新しい生活様式への変化が進んでいます。<br>
                    この流れはビジネスにおいて例外ではなく、DXやデジタルシフトを進め、<br>
                    販路拡大を行うことが大きな鍵になっています。<br><br>

                    そんな中、私たちオープンストア株式会社はオンライン市場に大きな希望の光を見出し、<br>
                    コロナ渦という逆境を大きな変革・チャンスと捉えています。<br><br>

                    私たちはお客様との対話を通じて本質的な課題を汲み取り、販路拡大や集客方法における<br>
                    ノウハウなどを一貫してサポートします。<br><br>

                    そして私たちは、お客さまにとって必要不可欠な最大のパートーナーとして末長く寄り添って<br>
                    お付き合いできる技術と情熱を持った担当者が揃っているという自負があります。<br><br>

                    コロナ渦などの如何なる理由はありますが、いつも夢の実現を妨げているのは自分自身です。<br><br>

                    「やり方がわからない。時間がない。もう歳だから。ニーズがない。結果が補償できない。」<br>
                    などの多くの声が妨げとなっています。<br><br>

                    これらの障壁を一つ一つ乗り越え、夢の実現に向けてのお手伝いを、<br>
                    是非、私たちオープンストア株式会社にお任せください。<br>
                </p>
            </div>
        </div>
    </div>
