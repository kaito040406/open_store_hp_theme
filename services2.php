...
<html lang="zxx">
    <head>
        <!-- meta tag -->
        <meta charset="utf-8">
        <title>Services 2 – Reobiz – Consulting Business HTML Template</title>
                                            ...
                                            <ul class="nav-menu">
                                                ...
                                                <li class="menu-item-has-children current-menu-item">
                                                    ...
                                                    <ul class="sub-menu">
                                                        ...
                                                        <li class="menu-item-has-children current-page-item">
                                                            <a href="#">Services</a>
                                                            <ul class="sub-menu">
                                                                <li><a href="services.html">Services 1</a> </li>
                                                                <li class="last-item active"><a href="services2.html">Services 2</a> </li>
                                                            </ul>
                                                        </li>
